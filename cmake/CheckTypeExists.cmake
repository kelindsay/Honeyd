...
# If the check needs to be done in C++, consider using CHECK_CXX_TYPE_EXISTS(),
# which does the same as CHECK_TYPE_EXISTS(), but in C++.
#
...
macro(CHECK_TYPE_EXISTS TYPE FILES VARIABLE)
  _CHECK_TYPE_EXISTS("${CMAKE_BINARY_DIR}${CMAKE_FILES_DIRECTORY}/CMakeTmp/CheckSymbolExists.c" "${TYPE}" "${FILES}" "${VARIABLE}" )
endmacro()

macro(_CHECK_TYPE_EXISTS SOURCEFILE TYPE FILES VARIABLE)
